    ...
    >
      ...
      <div
        style={{
          ...
          width: '28px',
          background: 'repeating-linear-gradient(0deg, #162447, #162447 2px, #E31F1F 2px, #E31F1F 4px)',
      ...
      >
        {/* Hanging Slot Hole */}
        <div
          className="w-11 h-2 bg-[#F5F3F2] dark:bg-[#131313]0/80 dark:bg-slate-900 rounded-full mx-auto mb-2.5 shadow-inner"
        />

        {/* Inner Card Surface */}
        <div
          className="w-full h-[calc(100%-16px)] rounded-[14px] relative overflow-hidden flex flex-col justify-between p-3.5 sm:p-4 bg-white dark:bg-[#0D1629] text-black dark:text-white dark:text-white border border-[#E4E4E4] dark:border-[#1E1E1E]/90 dark:border-white/10 shadow-sm"
        >
          ...
          <div className="absolute right-[-6px] bottom-0 w-[82%] h-[78%] pointer-events-none z-[1] overflow-hidden flex items-end justify-end">
            {!imgError ? (
              ...
              <div className="w-20 h-20 rounded-full bg-[#E31F1F]/10 dark:bg-cyan-400/10 flex items-center justify-center text-[#E31F1F] dark:text-cyan-400 mb-4 mr-2 border border-[#E31F1F]/20">
          ...
          <div 
            className="absolute inset-x-0 bottom-0 h-[46%] pointer-events-none z-[2] bg-gradient-to-t from-[#E31F1F] via-[#E31F1F]/90 via-[42%] to-transparent dark:from-[#14346B] dark:via-[#14346B]/90 dark:via-[42%] dark:to-transparent" 
          />

          {/* Layer 3: Text & Footer Content (In FRONT of Blue Gradient Overlay) */}
          <div className="mt-auto z-10 text-left pt-2">
            {/* DIRECTOR Tag */}
            <div className="text-[10px] sm:text-[11px] font-mono font-black tracking-widest text-cyan-300 uppercase mb-0.5 drop-shadow-md">
              DIRECTOR
            </div>
            ...
            {/* Cyan Accent Line Bar */}
            <div className="w-full h-[3px] sm:h-[3.5px] rounded-full bg-cyan-400 my-2 shadow-xs" />
  ...
  return (
    <section className="relative w-full py-12 sm:py-16 px-4 sm:px-6 lg:px-8 overflow-hidden rounded-3xl bg-surface-subtle/70 dark:bg-[#070D1A] border border-surface-border shadow-xl my-6 transition-colors duration-300">
      ...
      <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-12 space-y-3">
        <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#E31F1F]/10 dark:bg-cyan-500/10 border border-[#E31F1F]/20 dark:border-cyan-400/30 text-[#E31F1F] dark:text-cyan-400 text-xs font-mono font-bold tracking-widest uppercase">
      ...
      {/* Mobile Swipe Hint */}
      <div className="md:hidden text-center text-[10.5px] font-mono font-bold tracking-widest text-[#7D797A] dark:text-cyan-400/80 flex items-center justify-center gap-2 pt-2 uppercase">
