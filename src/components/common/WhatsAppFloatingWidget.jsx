...
export default function WhatsAppFloatingWidget() {
  ...
  return (
    <div className="fixed bottom-18 sm:bottom-20 right-4 sm:right-6 rtl:right-auto rtl:left-4 sm:rtl:left-6 z-40 flex flex-col items-end rtl:items-start gap-3">
      {isOpen && (
