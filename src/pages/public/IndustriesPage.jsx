              ...
              >
                ...
                <div className="relative h-48 w-full overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 rtl:left-auto rtl:right-4">
                    <span className="text-xs font-mono px-3 py-1 rounded-full bg-surface-raised/90 backdrop-blur-md text-[#DD2A40] dark:text-[#E4E7EC] border border-surface-border font-bold shadow-sm">
                ...
                <div className="p-6 space-y-4 flex-1 flex flex-col justify-between">
                  <div className="space-y-2">
                    <h3 className="font-sans tracking-tight text-lg font-bold text-black dark:text-white dark:text-white group-hover:text-[#DD2A40] dark:group-hover:text-[#FF3333] transition-colors leading-snug">
                      {ind.name}
                    </h3>
