            ...
            return (
              ...
              >
                ...
                <div className="relative h-48 w-full overflow-hidden">
                  ...
                  <div className="absolute bottom-3 right-4 w-12 h-12 rounded-2xl bg-surface-raised/90 backdrop-blur-md text-[#DD2A40] dark:text-[#FF3333] border border-surface-border flex items-center justify-center shadow-md group-hover:scale-110 transition-transform">
                ...
                <div className="p-6 space-y-4 flex-1 flex flex-col justify-between">
                  ...
                  <div className="pt-4 border-t border-surface-border flex items-center justify-between">
                    <span className="text-xs font-mono font-bold text-[#667085] dark:text-[#667085]">
                      {r.jurisdiction}
                    </span>
